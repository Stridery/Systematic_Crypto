...
class LightGBMTrainer:
    ...
    def __init__(
        ...
        if model_path is None:
            ...
            self.model_path = model_dir / f"{timeframe}_p{lookahead_periods}_lightgbm.pkl"
        else:
    ...
    def load_data(self, train_ratio: float = None, use_strong_only: bool = True):
        ...
        print(f"[train_lgb] Weight stats: min={weights_all.min():.4f}, max={weights_all.max():.4f}, mean={weights_all.mean():.4f}")
