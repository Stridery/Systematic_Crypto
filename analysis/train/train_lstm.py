...
MODEL_PKL_PATH = MODEL_DIR / "1h_lstm.pkl"
...
def train_lstm_model(
    ...
    print(f"[train_lstm] Reading data from {DATA_PATH} ...")
    ...
    evaluate_split(model, train_loader_eval, idx_to_label, "TRAIN", device)
    evaluate_split(model, val_loader, idx_to_label, "VAL", device)
    ...
    nn_model.save(MODEL_PKL_PATH)

    print(f"\n[train_lstm] LSTM NNModel saved to {MODEL_PKL_PATH}")
